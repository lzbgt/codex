...
pub fn builtin_approval_presets() -> Vec<ApprovalPreset> {
    vec![
        ...
        ApprovalPreset {
            id: "auto",
            label: "Auto",
            description: "Codex can read files, make edits, run commands, and access the network in the workspace. Codex requires approval to work outside the workspace",
            approval: AskForApproval::OnRequest,
